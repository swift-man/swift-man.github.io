...
전체적으로 TV 사용 환경이 더 쾌적해졌고, 아이폰과의 쌍으로 연결을 통한 딜레이가 없어지고 제어가 편해졌다.  
...
국내 TV 서비스를 주로 이용한다면 현재 지원되는 서비스가 적어 한국에 정식 서비스를 할 때까지 기다리는 것이 좋아 보인다.  
한국 정식 서비스를가 오픈되면 현 상황의 일부 제약사항과 불편함이 해소되어 더 재미있는 기능을 사용할 수 있을 거라 기대해본다.
