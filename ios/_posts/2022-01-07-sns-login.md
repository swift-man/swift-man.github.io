...
    func logIn() -> Observable<LogInParameter> {
        return Observable<LogInParameter>.create { observer in
...
    var onSuccess: ((LogInParameter) -> Void)?
...
    func facebookLogIn(target: UIViewController) -> Observable<LogInParameter> {
        return flatMap { _ -> Observable<LogInParameter> in
            return FacebookLogIn(target: target).logIn()
        }
    }

    func kakaoLogIn(target: UIViewController) -> Observable<LogInParameter> {
        return flatMap { _ -> Observable<LogInParameter> in
            return KakaoLogIn(target: target).logIn()
        }
    }

    func googleLogIn(target: UIViewController) -> Observable<LogInParameter> {
        return flatMap { _ -> Observable<LogInParameter> in
            return GoogleLogIn(target: target).logIn()
        }
    }
    @available(iOS 13.0, *)
    func appleLogIn(target: UIViewController) -> Observable<LogInParameter> {
        return flatMap { _ -> Observable<LogInParameter> in
...
    func paycoLogIn(target: UIViewController) -> Observable<LogInParameter> {
        return flatMap { _ -> Observable<LogInParameter> in
